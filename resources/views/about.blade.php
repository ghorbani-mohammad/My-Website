...
@section('content')
    <div class="row mt-5 mb-5">
        ...
        <div class="col-12 col-sm-6 col-md-9 col-lg-10 mt-3" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">
            ...
            <br>
            <p class="figure-caption">Probably you will say "Do you ever heard about Facebook or Twitter?" You are right! But you know what? I am a progrmmer (skillful one :/) and i want to have my own stuff.</p>
